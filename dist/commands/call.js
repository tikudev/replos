...
exports.call = function (config) { return function (argString) { return __awaiter(void 0, void 0, void 0, function () {
    var fileLocation, _a, functionName, functionParameterGroups, ast, functionCall, repl, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                fileLocation = parse_1.parseFileLocation(string_1.words(argString))(1);
                return [4 /*yield*/, setup_1.getFunctionInfo(fs_1.default.readFileSync(fileLocation.file).toString())(fileLocation)];
            case 1:
                _a = _d.sent(), functionName = _a.functionName, functionParameterGroups = _a.functionParameterGroups, ast = _a.ast;
            ...
            case 3:
                ...
                _d.sent();
                _c = (_b = console).log;
                return [4 /*yield*/, replIO_1.sendStringifyEvalToRepl(repl)(functionCall)];
            case 4:
                _c.apply(_b, [_d.sent()]);
                repl.end();
                return [2 /*return*/];
